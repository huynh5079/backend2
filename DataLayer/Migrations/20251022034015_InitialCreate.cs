        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LevelName = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Educatio__6F6237CDB26778B5", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Subject__AC1BA3A8ED7AD384", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    EducationLevelId = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Wallet__84D4F90EC6481D7E", x => x.Id);
                    table.ForeignKey(
                        name: "FK__Wallet__UserId__1BC821DD",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TutorId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: true),
                    SubjectId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: true),
                    EducationLevelId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Transact__55433A6BD42E289E", x => x.Id);
                    table.ForeignKey(
                        name: "FK__Transacti__Walle__1CBC4616",
                        column: x => x.WalletId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApprovalStatus = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true, defaultValue: "Pending"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RecurringSchedule_Class",
                        column: x => x.ClassID,
                        principalTable: "Class",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Class_EducationLevelId",
                table: "Class",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassRequest_EducationLevelId",
                table: "ClassRequest",
                column: "EducationLevelId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassRequest_SubjectId",
                table: "ClassRequest",
                column: "SubjectId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecurringSchedule_ClassID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentProfile_EducationLevelId",
